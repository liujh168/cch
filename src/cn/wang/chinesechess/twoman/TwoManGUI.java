 ...
 *
 */
public class TwoManGUI extends JFrame implements ActionListener, ISaveManual,NAME{
	...
	public void actionPerformed(ActionEvent e) {
		...
		// 悔棋
			...
			TwoManGUI newgame = new TwoManGUI();
	...
	private void movePieceByManual(String manual) {
		...
		if (manual != null && manual.length() == 4) {
			...
			if (rule) {
				...
				curIndex++;ChessUtil.playSound("eat.wav");
				validate();repaint();board.changeSide();	
			}
		}
	}
	/**
	...
	public static void main(String[] args) {
		TwoManGUI twoManGUI = new TwoManGUI();
		twoManGUI.setVisible(true);
	}
	@Override
	public ArrayList<String> getSavePaths() {
		ArrayList<String> paths = new ArrayList<String>();
		String path = "src/manuals/player/";
		String path2 = "src/manuals/player/";
	...
	public GameRecord getGameRecord() {
		GameRecord gameRecord = new GameRecord(ManualType.TWO_MAN,
